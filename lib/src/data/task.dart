...
class Task {
	...
	Task({this.id, this.name, this.status, this.orderindex, this.dateCreated, this.dateUpdated, this.dateClosed, this.creator, this.assignees, this.checklists, this.tags, this.parent, this.priority, this.dueDate, this.startDate, this.timeEstimate, this.timeSpent, this.list, this.folder, this.space, this.url});
	...
	Task.fromJson(Map<String, dynamic> json) {
		...
		if (json['assignees'] != null) {
			...
			json['assignees'].forEach((v) { assignees.add(v); });
		}
		if (json['checklists'] != null) {
			checklists = new List<dynamic>();
			json['checklists'].forEach((v) { checklists.add(v); });
		}
		if (json['tags'] != null) {
			tags = new List();
		...
		if (json['list'] != null) {
			...
			json['list'].forEach((v) { clickUpList.add(new null.fromJson(v)); });
		}
		folder = json['folder'] != null ? new Folder.fromJson(json['folder']) : null;
